...
/**
 * DepthCardBannerActivity
 *
 * @author joker
 * @date 2018/1/19
 */
public class DepthCardBannerActivity extends AppCompatActivity {
        ...
        bannerPager0
                ...
                .setPages(data, new ViewHolderCreator<BannerPagerHolder>() {
                    ...
                    public BannerPagerHolder createViewHolder() {
                        final View view = LayoutInflater.from(DepthCardBannerActivity.this).inflate(R.layout.item_image_banner, null);
